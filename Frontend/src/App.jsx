...
export const App = () => {
  ...
  const fetchDataOrder = async () => {
    try {
      ...
      const tableOrders = currentOrders.find(
        (entry) => entry.tableId === selectedTable
      );
  ...
  return (
    ...
    >
      ...
      {/* <h1 style={{ textAlign: "center", color: "Black", fontWeight: "bold" }}>Order Management      </h1> */}
      ...
      >
        <button
          ...
          style={{
            ...
            boxShadow:
              role === "Take Order" ? "0 4px 15px rgba(0, 0, 0, 0.2)" : "none", // Soft shadow for active button
        ...
        <button
          ...
          style={{
            ...
            boxShadow:
              role === "Show Orders" ? "0 4px 15px rgba(0, 0, 0, 0.2)" : "none", // Soft shadow for active button
            transition: "all 0.3s ease", // Smooth transition for hover and active states
          }}
          onMouseEnter={(e) => (e.target.style.backgroundColor = "#d91e3c")} // Hover state
          onMouseLeave={(e) =>
        ...
        <button
          ...
          style={{
            ...
            boxShadow:
              role === "Bills" ? "0 4px 15px rgba(0, 0, 0, 0.2)" : "none", // Soft shadow for active button
            transition: "all 0.3s ease", // Smooth transition for hover and active states
          }}
          onMouseEnter={(e) => (e.target.style.backgroundColor = "#d91e3c")} // Hover state
          onMouseLeave={(e) =>
            ...
            {[1, 2, 3, 4, 5, 6].map((table) => (
              <button
                ...
                style={{
                  ...
                  // width: "130px",
                  backgroundColor:
                    selectedTable === table ? "#b50e2d" : "#9e9e9e", // Premium red for active, soft gray for inactive
                  color: "white",
                  border: "none",
                  ...
                  boxShadow:
                    selectedTable === table
                      ...
                      : "none", // Soft shadow on active button
                  transition: "all 0.3s ease", // Smooth transition for hover and active states
                }}
                onMouseEnter={(e) =>
      ...
      {role === "Take Order" && selectedTable && (
        <div>
          <h3
            style={{ color: "black", fontWeight: "bold", marginBottom: "5px" }}
          >
            Taking Orders for Table {selectedTable}
          </h3>
